...
- [x] 2. Update database schema for email verification
  ...
  - [x] 2.1 Add email verification fields to User model in Prisma schema
  ...
  - [x] 2.2 Create and run database migration
...
- [x] 3. Implement backend email service


  - [x] 3.1 Create email service class with SMTP configuration
  ...
  - [x] 3.2 Create verification email HTML template
  ...
  - [x] 3.3 Add email service connection test endpoint
...
- [x] 4. Implement verification code generation and validation


  - [x] 4.1 Add verification code generation logic to auth service
  ...
  - [x] 4.2 Implement code validation logic
...
- [x] 5. Update auth service for email verification flow





  - [x] 5.1 Modify register method to create pending user
  ...
  - [x] 5.2 Implement verifyEmail method
  ...
  - [x] 5.3 Implement resendVerificationCode method
  ...
  - [x] 5.4 Add cleanup method for expired pending accounts
...
- [x] 6. Implement rate limiting middleware


  - [x] 6.1 Create rate limiting for verification code requests
  ...
  - [x] 6.2 Create rate limiting for verification attempts
...
- [x] 7. Create auth controller endpoints for verification


  - [x] 7.1 Update register endpoint to handle verification flow
  ...
  - [x] 7.2 Create verify-email endpoint
  ...
  - [x] 7.3 Create resend-verification endpoint
...
- [x] 8. Update auth routes with new endpoints
...
- [x] 9. Update login endpoint to check email verification
...
- [x] 10. Create email verification page in Flutter
  ...
  - [x] 10.1 Create EmailVerificationPage widget
  ...
  - [x] 10.2 Implement 6-digit code input UI
  ...
  - [x] 10.3 Add countdown timer for code expiry
...
- [ ] 11. Update auth repository with verification methods
  - [x] 11.1 Add verifyEmail method to AuthRepository
  ...
  - [x] 11.3 Update register method response handling
...
- [-] 13. Implement verification page logic and error handling
  ...
  - [x] 13.3 Implement resend code logic
