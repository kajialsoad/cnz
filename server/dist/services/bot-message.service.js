...
class BotMessageService {
     ...
     */
    async trackBotTrigger(chatType, messageKey, stepNumber) {
        try {
     ...
     */
    async trackAdminReply(chatType, currentStep) {
        try {
            const today = new Date();
            today.setHours(0, 0, 0, 0);
    ...
    async getBotAnalytics(query) {
        try {
            ...
            const adminReplyRate = totalTriggers > 0 ? (totalReplies / totalTriggers) * 100 : 0;
...
exports.BotMessageService = BotMessageService;
// Export singleton instance
exports.botMessageService = new BotMessageService();
