...
exports.MAX_FILE_SIZES = exports.ALLOWED_AUDIO_TYPES = exports.ALLOWED_IMAGE_TYPES = void 0;
exports.sanitizeFilename = sanitizeFilename;
exports.generateSecureFilename = generateSecureFilename;
exports.validateFileType = validateFileType;
exports.validateFileSize = validateFileSize;
exports.hasDangerousExtension = hasDangerousExtension;
...
function sanitizeFilename(filename) {
    ...
    let sanitized = path_1.default.basename(filename);
    // Remove null bytes
...
function validateImageFile(file) {
    ...
    // Validate file type
    const typeValidation = validateFileType(file.mimetype, exports.ALLOWED_IMAGE_TYPES);
    if (!typeValidation.valid) {
        return typeValidation;
    }
    // Validate file size
    const sizeValidation = validateFileSize(file.size, exports.MAX_FILE_SIZES.IMAGE);
...
function validateAudioFile(file) {
    ...
    // Validate file type
    const typeValidation = validateFileType(file.mimetype, exports.ALLOWED_AUDIO_TYPES);
    if (!typeValidation.valid) {
        return typeValidation;
    }
    // Validate file size
    const sizeValidation = validateFileSize(file.size, exports.MAX_FILE_SIZES.AUDIO);
    if (!sizeValidation.valid) {
        return sizeValidation;
    }
    return { valid: true };
 ...
 * @returns Validation result
 */
function validateMultipleFiles(files, fileType, maxFiles) {
