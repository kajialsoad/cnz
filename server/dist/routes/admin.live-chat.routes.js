 ...
 */
router.post('/:userId', rate_limit_middleware_1.messageRateLimit, upload_config_1.uploadConfig.single('image'), admin_live_chat_controller_1.adminLiveChatController.sendMessage.bind(admin_live_chat_controller_1.adminLiveChatController));
/**
