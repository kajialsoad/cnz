...
router.get('/analytics/others', admin_complaint_controller_1.getOthersAnalytics);
...
router.patch('/:id/mark-others', upload_config_1.uploadConfig.array('images', 5), admin_complaint_controller_1.markComplaintAsOthers);
