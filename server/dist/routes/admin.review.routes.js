 ...
 */
router.get('/analytics/reviews', auth_middleware_1.authGuard, (0, auth_middleware_1.rbacGuard)('SUPER_ADMIN', 'ADMIN', 'MASTER_ADMIN'), reviewController.getReviewAnalytics);
